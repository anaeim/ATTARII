...
class AmazonTabularContentScraper():
    ...
    product_detail_table_write_path : str
        the path of json file in which the product detail tables are written (default ./extracted_contents/product_detail_table.json)
    product_overview_table_write_path : str
        the path of json file in which the product overview tables are written (default ./extracted_contents/product_overview_table.json)
    ...
    def __init__(self, URL):
        ...
        self.product_detail_table_write_path = './extracted_contents/product_detail_table.json'
        self.product_overview_table_write_path = './extracted_contents/product_overview_table.json'
